      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            t.true(_rec._expr(_rec._capt(_rec._capt(user_1, 'arguments/0/object').isNew, 'arguments/0'), {
              content: 't.true(user_1.isNew, \'user\\\'s `isNew` flag is false after a save\')',
              filepath: 'ava-test/tests/create_test.js',
              line: 25,
              async: true,
              ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"user_1","range":[7,13]},"property":{"type":"Identifier","name":"isNew","range":[14,19]},"computed":false,"range":[7,19]},{"type":"StringLiteral","value":"user\'s `isNew` flag is false after a save","range":[21,65]}],"range":[0,66]}',
              tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"user_1","range":[7,13]},{"type":{"label":"."},"range":[13,14]},{"type":{"label":"name"},"value":"isNew","range":[14,19]},{"type":{"label":","},"range":[19,20]},{"type":{"label":"string"},"value":"user\'s `isNew` flag is false after a save","range":[21,65]},{"type":{"label":")"},"range":[65,66]}]',
...
//# sourceMappingURL=../../node_modules/.cache/ava/573a4d0eed13332a7a56d2bcd6088c1c.js.map