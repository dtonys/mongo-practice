    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return _user2.default.find({}).sort({ name: 1 }).skip(1).limit(2);

          case 2:
            allUsers = _context6.sent;

            t.is(allUsers[0].name, 'Alex', 'the correct first user was found based on the `skip` and `sort` params');
            t.is(allUsers[1].name, 'Joe', 'the correct second user was found based on the `skip` and `sort` params');
...
//# sourceMappingURL=../../node_modules/.cache/ava/2d4a75a6908b5fdc40c01674f042bc8d.js.map