...
_ava2.default.serial('Make user name required', function () {
  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(t) {
    var user, validationResult, user2, validationResult2;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            console.log('validationResult.errors.name');
            console.log(validationResult.errors.name);

            console.log('validationResult');
            console.log(validationResult);

            user2 = new _user2.default({ name: 'user2' });
            validationResult2 = user2.validateSync();
...
//# sourceMappingURL=../../node_modules/.cache/ava/a9c7e21fc869ccd472d257885a8c7bcd.js.map