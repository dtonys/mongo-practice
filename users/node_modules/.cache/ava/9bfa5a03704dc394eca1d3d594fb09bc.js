...
var _test_helper = require('../../src/user/test_helper');
...
_ava2.default.beforeEach('drop users table', function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _mongoose2.default.connection.collections.users.drop();
...
_ava2.default.serial('Create a new user ', function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            t.true(_rec._expr(_rec._capt(!_rec._capt(_rec._capt(user_1, 'arguments/0/argument/object').isNew, 'arguments/0/argument'), 'arguments/0'), {
              content: 't.true(!user_1.isNew, \'user\\\'s `isNew` flag is false after a save\')',
              filepath: 'ava-test/tests/create_test.js',
              line: 23,
              async: true,
              ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"UnaryExpression","operator":"!","argument":{"type":"MemberExpression","object":{"type":"Identifier","name":"user_1","range":[8,14]},"property":{"type":"Identifier","name":"isNew","range":[15,20]},"computed":false,"range":[8,20]},"prefix":true,"range":[7,20]},{"type":"StringLiteral","value":"user\'s `isNew` flag is false after a save","range":[22,66]}],"range":[0,67]}',
              tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"prefix"},"value":"!","range":[7,8]},{"type":{"label":"name"},"value":"user_1","range":[8,14]},{"type":{"label":"."},"range":[14,15]},{"type":{"label":"name"},"value":"isNew","range":[15,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"string"},"value":"user\'s `isNew` flag is false after a save","range":[22,66]},{"type":{"label":")"},"range":[66,67]}]',
              visitorKeys: _powerAssertVisitorKeys
            }), 'user\'s `isNew` flag is false after a save');
...
_ava2.default.after.always('disconnect from database', _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
...
//# sourceMappingURL=../../node_modules/.cache/ava/9bfa5a03704dc394eca1d3d594fb09bc.js.map